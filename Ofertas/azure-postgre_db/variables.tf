...
variable "componente" {
  description = "Sigla que identifica o tipo do recurso"
  type        = string
}
...
variable "gerenciamento" {
  description = "Define a origem de provisionamento do recurso"
  type        = string
}

// ========================================
// =====  Variáveis para Tags Backup  =====
// ========================================

variable "bkp-retencao" {
  description = "Tempo de retenção de Backup"
  type        = string
}

variable "bkp-segmento" {
  description = "Segmento do ambiente"
  type        = string
}

variable "bkp-criticidade" {
  description = "Criticidade do Backup e dados (SIM/NAO)"
  type        = string
}

variable "bkp-ambiente" {
  description = "Ambiente do Backup (PROD/NPROD)"
  type        = string
}
